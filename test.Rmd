...
hrs_data <- read.spss("HRS2020_CLEAN.sav", to.data.frame = TRUE, reencode = "UTF-8")

# Clean and trim the METRO_NAME column
hrs_data$METRO_NAME <- trimws(hrs_data$METRO_NAME)
hrs_data$METRO_NAME <- iconv(hrs_data$METRO_NAME, from = "UTF-8", to = "UTF-8", sub = "")
```
